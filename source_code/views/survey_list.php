        ...
        <div class="card-body">
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    ...
                    $qry = $conn->query("SELECT * FROM survey_set where user_id = {$_SESSION['user_id']} order by date(start_date) asc,date(end_date) asc ");
                    
					while($row= $qry->fetch_assoc()):
                    ?>
                    <tr>
                        <th class="text-center"><?php echo $i++ ?></th>
                        <td><b class="truncate"><?php 
                        if($row['type']==0)
                            echo "General User";
                        else
                            echo "Education";
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-danger btn-flat delete_survey"
