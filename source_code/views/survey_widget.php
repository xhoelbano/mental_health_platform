...
<div class="col-lg-12">
    ...
    <div class="row">
        <?php
        if ($_SESSION['type'] == 3) //if general user
		    $survey = $conn->query("SELECT * FROM survey_set where survey_set.type=0 and '".date('Y-m-d')."' between date(start_date) and date(end_date) order by rand() ");
            
		
        elseif ($_SESSION['type'] == 4) //if student
            $survey = $conn->query("SELECT * FROM survey_set where survey_set.type=1 and '".date('Y-m-d')."' between date(start_date) and date(end_date) order by rand() ");
                ...
                <div class="card-body" style="display: block;">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-center w-100 text-center">
                            ...
                            <a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>"
                                class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i> Take Survey</a>
                            <?php else: ?>
