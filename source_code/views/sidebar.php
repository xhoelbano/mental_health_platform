    ...
    <div class="dropdown">
        <a href="javascript:void(0)" class="brand-link dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
            <span
                ...
                style="width: 38px;height:50px"><?php echo strtoupper(substr("Mental", 0,1).substr("Health", 0,1)) ?></span>
            <span class="brand-text font-weight-light"><?php echo "Menu"?></span>

        </a>
        <div class="dropdown-menu" style="">
            <a class="dropdown-item manage_account" href="javascript:void(0)"
                data-id="<?php echo $_SESSION['user_id'] ?>">Manage Account</a>
    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="./index.php?page=activation_code" class="nav-link ">
                ...
                <li class="nav-item">
                    <a href="./index.php?page=table_psychologist" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="./chat?page=index.php" class="nav-link">
                        <i class="nav-icon fa fa-comment"></i>
                        <p>
                ...
                <li class="nav-item">
                    <a href="./index.php?page=children_survey_report" class="nav-link">
                        <i class="nav-icon fas fa-poll"></i>
                        <p>
                            My Children Surveys Reports
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="./index.php?page=table_business" class="nav-link">
                        <i class="nav-icon fas fa-table"></i>
                        <p>
                            Table Business
                        </p>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="./index.php?page=new_school" class="nav-link tree-item">
                                <i class="fas fa-angle-right nav-icon"></i>
                                <p>Add New</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="./index.php?page=school_list" class="nav-link  tree-item">
                                <i class="fas fa-angle-right nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
