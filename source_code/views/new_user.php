                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="custom-select custom-select-sm">
                                <option value="3" <?php echo isset($type) && $type == 3 ? 'selected' : '' ?>>General
                                    User
                                </option>
                                <option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Business
                                </option>
                                <option value="1" <?php echo isset($type) && $type == 1 ? 'selected' : '' ?>>
                                    Psychologist
                                </option>
                                </option>
                                <option value="0" <?php echo isset($type) && $type == 0 ? 'selected' : '' ?>>
                                    Administrator
                                </option>
                            </select>
                        </div>
