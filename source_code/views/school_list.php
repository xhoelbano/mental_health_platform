        ...
        <div class="card-body">
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    <?php
					$i = 1;
					$qry = $conn->query("SELECT * FROM `schools`");
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item delete_school" href="javascript:void(0)"
...
$(document).ready(function() {
    ...
    $('.delete_school').click(function() {
        _conf("Are you sure to delete this school?", "delete_school", [$(this).attr('data-id')])
    })
})
