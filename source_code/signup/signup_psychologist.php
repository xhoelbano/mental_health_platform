...
<head>
    ...
    <title>Sign Up Psychologist</title>
</head>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7 py-5">
                        <h3>Psychologist Registration form</h3>
                        <p class="mb-4">After filling in the information we will check your email domain.</p>
                        <form action="../controller/register_psychologist.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group first">
                                        ...
                                        <input type="text" class="form-control" placeholder="e.g. K3423325325J"
                                            name="license_number" id="license_number" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
